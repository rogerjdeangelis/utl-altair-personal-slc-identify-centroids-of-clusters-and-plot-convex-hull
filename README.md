...
# Example dataset
data <- data.frame(
  x = rnorm(30, rep(1:3, each=20), 0.3),
  y = rnorm(30, rep(c(1,2,1), each=20), 0.3)
)
...
https://community.altair.com/discussion/39107/altair-monarch-learning-series-2023-exercise-6-solution-classic-sales-inventory-master-analysis?utm_source=community-search&utm_medium=organic-search&utm_term=exercis
